    ...
    function renderTimelines(maxElems) {
      ...
      newSegments.on('mouseover', function () {
        ...
        select(this).transition().duration(70).attr('x', function (d) {
          ...
          return max([state.minSegmentWidth, state.xScale(d.timeRange[1]) - state.xScale(d.timeRange[0])]) + hoverEnlarge;
        }).attr('y', function (d) {
        ...
        select(this).transition().duration(250).attr('x', function (d) {
          ...
          return max([state.minSegmentWidth, state.xScale(d.timeRange[1]) - state.xScale(d.timeRange[0])]);
        }).attr('y', function (d) {
